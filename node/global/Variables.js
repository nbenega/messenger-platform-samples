...
const CHAT_MESSAGE = '/chat/rest/Chasitor/ChatMessage';
const PAGE_ID = '106392932382716';
const IG_ACCOUNT_ID = '17841459132809567';
let mappingSesion = {};


module.exports = { APP_SECRET,VALIDATION_TOKEN,PAGE_ACCESS_TOKEN,SERVER_URL,URL_CHAT,ORG_ID,DEPLOYMENT_ID,BUTTON_ID,USER_AGENT,LANGUAGE,SCREEN_RESOLUTION,CREATE_SESSION,CREATE_VISITOR_SESSION,CHAT_MESSAGE,MESSAGES,PAGE_ID,IG_ACCOUNT_ID,mappingSesion};
